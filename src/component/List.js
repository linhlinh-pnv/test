...
class List extends Component {
  ...
  componentDidMount() {
    ...
    if (match) {
      ...
      axios({
      method: 'GET',
      url :`https://61ce7a697067f600179c5f0e.mockapi.io/products/${id}`,
      data : null
     }).then(res =>{
      var data =res.data;
        this.setState({
    ...
    axios.get('https://61ce7a697067f600179c5f0e.mockapi.io/products').then(res => {
  ...
  onSave = (event) => {
    ...
    if (this.state.id ==''){
      if(this.state.name !== '' && this.state.price!=='' && this.state.quantity !== '' && this.state.image!==''){
        axios({
          method:'POST',
          url :`https://61ce7a697067f600179c5f0e.mockapi.io/products`,
          data: {
      ...
      axios({
        method:'PUT',
        url :`https://61ce7a697067f600179c5f0e.mockapi.io/products/${this.state.id}`,
        data: {
          title: this.state.title,
          content: this.state.content,
          image : this.state.image,
